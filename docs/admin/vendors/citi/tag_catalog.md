...
For API endpoints, authentication, and rate limits, see [`api_reference.md`](api_reference.md).
...
Full tag: `FX.FORWARD.{TYPE}.{C1}.{C2}.{TENOR}.CITI` — see [exploration/fx_spot_forward.md](exploration/fx_spot_forward.md) for complete coverage.
...
> **Deep dive**: `docs/admin/vendors/citi/exploration/equity.md` — full exploration with sample data (2026-03-26)
...
> - `docs/admin/vendors/citi/exploration/rates_full.md` — full catalog of all 24 remaining subcategories (135,915 tags)
> - `docs/admin/vendors/citi/exploration/rates_inflation.md` — INFLATION deep dive (7,476 tags)
> - `docs/admin/vendors/citi/exploration/rates_sov_cmt.md` — SOV_CMT deep dive (8,250 tags, 32 countries confirmed)
> - `docs/admin/vendors/citi/exploration/rates_xccy_ois.md` — XCCY_OIS_SWAP deep dive (76,418 tags, all 90 G10 pairs)
> - `docs/admin/rates/swaption_vol_schema.md` — VOL (swaption vol) schema + operations
