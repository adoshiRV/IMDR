...
- Test directly: `python -c "import pyodbc; conn = pyodbc.connect('DRIVER={SQL Server};SERVER=<DB_HOST>;DATABASE=IMDR;Trusted_Connection=yes'); print('OK')"`
