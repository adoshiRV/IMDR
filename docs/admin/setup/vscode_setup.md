...
| Network access to `<DB_HOST>:1433` | Office network or VPN. |
...
| Prompt | Value |
|---|---|
| Server name | `<DB_HOST>` (request from DBA / ops) |
| Database name | `IMDR` |
...
- **Documentation**:
  - [docs/fx/fx_data_reference.md](../../fx/fx_data_reference.md) — FX consumer reference (schema, queries, coverage)
  - [docs/admin/fx/](../fx/) — FX ops detail (pipeline, runbooks, BBG integration)
  - [docs/rates/rates_data_reference.md](../../rates/rates_data_reference.md) — Rates consumer reference (schema, queries, coverage)
  - [docs/admin/rates/](../rates/) — Rates ops detail (pipeline, runbooks, swaption vol/skew)
  - [docs/commodities/commodities_data_reference.md](../../commodities/commodities_data_reference.md) — Citi commodity tables
  - [docs/equity/equity_data_reference.md](../../equity/equity_data_reference.md) — equity index levels + vol
  - [docs/calendar/calendar_data_reference.md](../../calendar/calendar_data_reference.md) — calendar data (markets, holidays, CB events)
  - [docs/admin/reference/schema_conventions.md](../reference/schema_conventions.md) — naming rules (`fact_` / `dim_`, FKs, timestamps)
...
- Facts join to dims on integer IDs (`pair_id`, `curve_id`, `country_id`, `vendor_id`, …), not string codes.
