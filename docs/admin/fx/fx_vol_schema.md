> **Historical design plan.** This was the original design plan. The pipeline is live as of 2026-04. Body retained as historical/design context; see [`fx_vol_operations.md`](fx_vol_operations.md) for current ops.
> Last updated: 2026-05-14 — removed dead `sources:` block from pipelines.yml snippet (`SourceConfig` and `sources:` field retired 2026-05-14).
