...
| **India (IN)** | Prod-live 26 × 39,569 (BIS + FRED + RBI DBIE FX reserves/Key Rates); 198 more indicators × 15k obs decoded in playground 2026-06-11 (MOSPI CPI/IIP/NAS · DPIIT WPI/8-Core · CGA · IMD · FAO) awaiting cadence sign-off | [india/](india/) | [§7.12](macro_economy_wiring_map.md#712-india-in) | — |
