...
| **India (IN)** | Prod-live 26 × 39,569 (BIS + FRED + RBI DBIE FX reserves/Key Rates). Pre-prod playground: **13 fetchers / ~908 indicators / ~62,100 obs** (MOSPI CPI/IIP/NAS · DPIIT WPI/8-Core · CGA · IMD · FAO · DGCIS · **UPAg MSP+AIAPY+IMC** · **RBI Bulletin 8 tables**). 2026-06-11 unlocks: DGCIS multi-month trade (198 × 30.9k obs · 2013→); UPAg via Plotly Dash callback decoder (closes Cluster 4 agri — AIAPY 60 FYs + A33 mandi prices); RBI Bulletin 8 tables via headed-Chrome TSPD-cleared XLSX; DBIE SPA AES encryption decoded (A5-A7 SAP-BO iframe extractor pending). | [india/](india/) | [§7.12](macro_economy_wiring_map.md#712-india-in) | — |
