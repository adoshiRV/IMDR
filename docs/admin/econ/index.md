...
Last updated: 2026-06-19 (IN: Track A Phase G prod-promotion — 15 fetchers wired; prior 2026-06-10 AU + ID)
...
| **Australia (AU)** | DB-LIVE (manual load) — **470 indicators / 397,118 obs**; ABS 18 fetchers / 22 dataflows (185 indicators incl. derived ToT + **CPI_Q quarterly trimmed mean/weighted median**) + RBA 9 fetchers via CSV snapshot (119 indicators incl. TIB + ICP + REER + ZCY) + AOFM 5 fetchers (157) + Cotality (6 daily HVI) + FRED-mirror (3); **16 of 16 cells ✅** (3.1 ToT closed 2026-06-11). Phase G blocker lifted. Production promotion pending user sign-off. | [australia/](australia/) | [§7.7](macro_economy_wiring_map.md#77-australia-au) | [australia_indicator_inventory.md](australia/australia_indicator_inventory.md) |
