...
| **Australia (AU)** | DB-LIVE (manual load) — **463 indicators / 397,053 obs**; ABS 17 fetchers / 20 dataflows (178 indicators) + RBA 9 fetchers via CSV snapshot (119 indicators incl. TIB + I2 ICP + F15 REER + F17 ZCY) + AOFM 5 fetchers (157) + Cotality (6 daily HVI) + FRED-mirror (3); **15 of 16 cells ✅**. Phase G blocker lifted. Production promotion pending user sign-off. | [australia/](australia/) | [§7.7](macro_economy_wiring_map.md#77-australia-au) | [australia_indicator_inventory.md](australia/australia_indicator_inventory.md) |
