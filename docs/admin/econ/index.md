...
| **Australia (AU)** | DB-LIVE (manual load) — **436 indicators / 357,623 obs**; ABS 17 fetchers / 20 dataflows (176 indicators incl. IIP + Building Approvals) + RBA 7 fetchers via CSV snapshot (100 indicators incl. TIB + I2 ICP) + AOFM 5 fetchers (157 indicators) + FRED-mirror (3); **15 of 16 cells ✅**. Phase G blocker lifted. Production promotion pending user sign-off. | [australia/](australia/) | [§7.7](macro_economy_wiring_map.md#77-australia-au) | [australia_indicator_inventory.md](australia/australia_indicator_inventory.md) |
