...
Updated 2026-06-10: **379 indicators / 339,631 obs DB-LIVE** (manual load). 14 of 16 cells ✅. ABS 15 fetchers / 18 dataflows (141 indicators) + RBA 5 fetchers via CSV snapshot (78 indicators) + AOFM 5 fetchers (157 indicators) + FRED-mirror (3). Phase G blocker lifted. Second-most-populated country after Indonesia. IIP probed 2026-06-10 (`playground/econ/abs/discovery/probe_iip.py`); load pending.
