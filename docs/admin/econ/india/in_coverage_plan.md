...
|---|---|---|---|
| ~~A4~~ RBI Bulletin tables | 2.4 · 4.3 · 1.1 · 1.4 · 3.4 · 4.4 | **RBI-Bulletin-XLSX** | **DONE 2026-06-11 (8 tables)** — [`playground/econ/in/rbi/rbi_bulletin.py`](../../../playground/econ/in/rbi/rbi_bulletin.py); **144 indicators × 533 obs** (T19C CPI · T27 Call Money · T23 IIP · T6 Money Stock M0/M1/M3 · T11 Reserve Money · T37 NEER/REER · **T22 WPI** · **T2 RBI Balance Sheet**). Generic `parse_wide_table` helper drives 6 of 8. Remaining priority tables awaiting parsers: BoP T40 (Credit/Debit/Net columns) · Foreign Trade T32 (dual-row INR/USD) · FX Reserves T33 (dual-row INR/USD) · SEI T1 (quarterly tags). Headed Chrome only (TSPD). |
...
| RBI Bulletin (A4) | MONTHLY/DAILY/WEEKLY | Bulletin publishes mid-month for prior month | 144 | 533 | **8 tables**: CPI T19C (28×84), Call Money T27 (3×84), IIP T23 (9×36), Money Stock T6 (15×45), Reserve Money T11 (10×30), NEER/REER T37 (2×32 — section-detection needs refinement), **WPI T22 (48×144)**, **RBI BS T2 (29×78)**. Generic `parse_wide_table` helper drives 6 of 8. Single-month snapshot per release — monthly orchestrator accumulates back-history MoM. **Headed Chrome required (TSPD).** |
