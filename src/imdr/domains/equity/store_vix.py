"""Parquet store for VIX family observations.

Layout: data/parquet/equities/fact_vix/{YYYY-MM}.parquet
"""
...
_log = structlog.get_logger("EquityVixParquetStore")

DATA_ROOT = Path("data/parquet/equities/fact_vix")
...
def write(
    ...
    """Write VIX DataFrame to parquet, split by month."""
