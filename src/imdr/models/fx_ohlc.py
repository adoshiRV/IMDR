...
class FXFactOHLC(Base):
    ...
    open_px: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    high_px: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    low_px: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    close_px: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    mid_px: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    mid_mean_px: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
    mid_median_px: Mapped[Decimal | None] = mapped_column(Numeric(18, 8), nullable=True)
