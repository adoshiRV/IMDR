"""FX vol ingest email formatter — Jinja2 + inline CSS for professional Outlook emails."""
...
def _fmt_vol(val: Any) -> str:
    """Format a vol value to 2 decimal places."""
    try:
...
def _prepare_pair_groups(
    ...
    """Group pairs by ccy_class, sort each group by pair name."""
...
class FXVolIngestFormatter:
    """Formats HTML emails for FX vol ingestion results."""
    ...
    def __init__(self) -> None:
        ...
        self._template = self._env.get_template("fx_vol_ingest.html")
    ...
    def format_subject(
        ...
        **kwargs: Any,
        ...
        return (
            f"[IMDR] FX Vol {mode} Ingest {status} | {date_str} "
