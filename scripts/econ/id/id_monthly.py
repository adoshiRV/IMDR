...
PIPELINES: list[list[str]] = [
    ...
    [sys.executable, "-m", "scripts.econ.bis.bis_indonesia"],
    # BPS (10 fetchers, REST JSON)
    [sys.executable, "-m", "scripts.econ.bps.bps_cpi"],
    [sys.executable, "-m", "scripts.econ.bps.bps_cpi_groups"],
    [sys.executable, "-m", "scripts.econ.bps.bps_gdp"],
    [sys.executable, "-m", "scripts.econ.bps.bps_gdp_components"],
    [sys.executable, "-m", "scripts.econ.bps.bps_ip"],
    [sys.executable, "-m", "scripts.econ.bps.bps_labour"],
    [sys.executable, "-m", "scripts.econ.bps.bps_ppi"],
    [sys.executable, "-m", "scripts.econ.bps.bps_prices_current"],
    [sys.executable, "-m", "scripts.econ.bps.bps_sakernas"],
    [sys.executable, "-m", "scripts.econ.bps.bps_trade"],
    # BI (14 fetchers, SEKI XLSX + Survey ZIPs)
    [sys.executable, "-m", "scripts.econ.bi.bi_bank_bs"],
    [sys.executable, "-m", "scripts.econ.bi.bi_bank_credit"],
    [sys.executable, "-m", "scripts.econ.bi.bi_bank_rates"],
    [sys.executable, "-m", "scripts.econ.bi.bi_bop"],
    [sys.executable, "-m", "scripts.econ.bi.bi_business_survey"],
    [sys.executable, "-m", "scripts.econ.bi.bi_consumer_survey"],
    [sys.executable, "-m", "scripts.econ.bi.bi_fiscal"],
    [sys.executable, "-m", "scripts.econ.bi.bi_fx_reserves"],
    [sys.executable, "-m", "scripts.econ.bi.bi_monetary_base"],
