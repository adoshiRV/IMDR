...
**Universe:** AU · NZ · JP · KR · IN · TH · ID · MY · SG · HK · PH · US · CA · UK
...
| **BoK +25bp expected — today** | Bank of Korea decision (`cb_events` 65683; FORWARD, 10:00 KST) | Survey/forecast hike to **2.75%** (prior 2.50%) — the base case. The debate is the path: the market prices the most hikes in Asia-ex-Japan (≥100bp/12m) vs the houses' ~75bp (Nomura). June oil relief (import prices −3.4% m/m) + jobless 2.7% (from 2.8%) + export prices +48.9% y/y on semis frame a benign-but-firm backdrop. KRW +0.13%, KTB-swap 2y −2.7bp into the meeting. |
...
| South Korea | KRW **+0.13%** | KTB-swap **−2.7** | KTB-swap **−0.4** | KOSPI 200 +1.25% (07-14) | **BoK decides today** (+25bp to 2.75% base case). Rates eased into the meeting; market prices the most hikes in AEJ (≥100bp/12m) vs houses' ~75bp (Nomura receive-Korea-vs-Taiwan, conv. cut to 3/5). Oil relief in trade prices; jobless 2.7%. |
...
| South Korea | **2.50%** | Held 2026-05-28 (2.50%) | **BoK decision 16-Jul (today)** | **+25bp to 2.75% the likely first hike of the cycle.** Path the debate: market prices the most hikes in AEJ (≥100bp/12m) vs houses' ~75bp (Nomura receive-Korea-vs-Taiwan, conv. cut to 3/5); June oil relief (import prices −3.4% m/m), jobless 2.7%, export prices +48.9% on semis; KRW +0.13% |
...
- **Korea — the BoK hike vs the priced path.** A +25bp to 2.75% is today's base case, but the market prices the most hikes in Asia-ex-Japan (≥100bp/12m, 2yfwd3y NDIRS at 2022 highs) against the houses' ~75bp (Nomura 18627, receive-Korea-vs-Taiwan, conviction cut to 3/5). Underpinned by the semiconductor-export cycle (export prices +48.9% y/y) with June oil relief (import prices −3.4% m/m) and an easing jobless rate (2.7%). The read: Korea rates look richly priced for the cycle.
...
7. **BoK (today)** — a +25bp hike to 2.75% the base case, but does the BoK validate the market's ≥100bp/12m path or lean toward the houses' ~75bp? Nomura cut conviction on receive-Korea-vs-Taiwan into the event; the semiconductor cycle and KRW are the swing factors.

---

## 7. Calendar — releases + CB events with rate relevance  *(FACT — `cb_events`; pure calendar, no view)*

Ordered **chronologically by release time** (`cb_events.event_datetime`), earliest first — the day's sequence as it unfolds, not grouped by country. Time shown in the event's **local market time** with a tz label. Consensus (`survey`/`forecast`) shown where present; `actual` only where the row carries one; `®` = prior revised. Where a release time is a placeholder, `— (time TBC)`, sorted to the end of its date. US PPI, the BoC decision, China credit, Japan machine orders/tertiary, Korea trade prices/employment and NZ card spending all PRINTED; the BoK, US retail sales and UK GDP are today's forward events.

| Date | Time (local) | Country | Event | Consensus | Prior | Actual |
|---|---|---|---|---|---|---|
| 07-15 | 06:00 KST | KR | Export / import prices y/y | 52.2% / 23% | 47.1%® / 25.4%® | 48.9% / 20.6% — PRINTED |
| 07-15 | 08:00 KST | KR | Unemployment rate SA | 2.8% | 2.8% | 2.7% — PRINTED |
| 07-15 | 13:30 JST | JP | Tertiary industry index m/m | 0.4% | 0.8%® | 1.1% — PRINTED |
| 07-15 | 18:45 NZST | NZ | Card spending retail m/m | — | 1.7%® | −1.4% — SOFT |
| 07-15 | 15:00 CST | CN | New yuan loans; TSF; M2 y/y | 2,000B / 3,770B / 8.5% | 520B / 2,030B / 8.6% | 1,610B / 3,360B / 8.0% — MISS |
| 07-15 | 15:00 CST | CN | Loan growth y/y | 5.4% | 5.5% | 5.2% — record low |
| 07-15 | 16:50 JST | JP | Core machine orders m/m; y/y | −4.2% / 12.3% | 8.67% / 15.6% | −12.4% / −1.9% — SOFT |
| 07-15 | 16:00 IST | IN | Unemployment rate | 5.4% | 5.5% | 5.5% — PRINTED |
| 07-15 | 18:52 PHT | PH | Overseas remittances y/y | 2.1% | 2.0% | 2.0% — PRINTED |
| 07-15 | 18:06 WIB | ID | External debt ($bn) | — | 439.8® | 444.4 — PRINTED |
| **07-15** | **08:30 ET** | **US** | **PPI m/m / y/y; core m/m / y/y** | **0% / 6.2%; 0.4% / 5.2%** | **0.6%® / 6%®; 0.1%® / 4.6%®** | **−0.3% / 5.5%; 0.2% / 4.7% — SOFT** |
| 07-15 | 08:30 ET | US | PPI ex food/energy/trade m/m; Empire | 0.3% / 9.2 | 0.8% / 5.7 | 0.1% / 15.6 — PRINTED |
| **07-15** | **09:45 ET** | **CA** | **Bank of Canada decision + MPR + presser** | **hold 2.25%** | **2.25%** | **2.25% — HELD** |
| 07-15 | 14:00 ET | US | Fed Beige Book | — | — | "slight to moderate" |
| **07-16** | **10:00 KST** | **KR** | **BoK base rate** | **hike 2.5→2.75%** | **2.5%** | **forward** |
| **07-16** | **07:00 BST** | **UK** | **GDP m/m / y/y; IP m/m** | **0.1% / 1.4% / −0.1%** | **−0.1% / 1.2% / 0%** | forward |
| **07-16** | **08:30 ET** | **US** | **Retail sales m/m; control; ex-auto** | **0.2% / 0.5% / −0.1%** | **0.9% / 0.7% / 0.8%** | forward |
| 07-16 | 08:30 ET | US | Initial jobless claims; Philadelphia Fed | 217K / 10.3 | 215K / 10.3 | forward |
| 07-16 | 10:45 NZST (17th) | NZ | Food inflation y/y | 3.0% | 3.2% | forward |
| 07-17 | 08:30 SGT | SG | Balance of trade (NODX) | $6.0B | $5.57B | forward |
| 07-17 | 12:00 MYT | MY | CPI y/y; Q2 GDP prelim y/y | 2.0% / 5.3% | 2.0% / 5.4% | forward |
| 07-17 | 16:30 HKT | HK | Unemployment rate | 3.7% | 3.7% | forward |
| 07-17 | 09:15 ET | US | Industrial production m/m | 0.2% | 0.1% | forward |
| 07-21 | — (time TBC) | NZ | Q2 CPI | ~1.3% q/q (RBNZ) | — | forward |
| 07-22 | — (time TBC) | ID | Bank Indonesia decision | — | 5.75% | forward |
| 07-27–31 | — (window) | SG | MAS MPS | — | band | forward |
| 07-29 | — (time TBC) | US/AU | FOMC; AU Q2 CPI | hold / ~0.8% q/q | 3.75% | forward |
...
### South Korea — BoK decides today, a +25bp hike the base case; the house-vs-market fight is over the path

*Flagships read: Nomura "Strategy Trade — Korea rates: Maintain receive versus Taiwan" (18627); JPM "Korea: June employment rose, but details remained mixed" (18624) + "Korea: June trade prices show oil relief and tech strength" (18665); GS "Korea Daily (Jul 15): KOSPI" (18586) + "GS Asia: Korea updates" (18589) + "Geopolitics, Diesel, and Korea" (18774); BoK "Export/Import Price Indexes" (18374) + "Monetary and Liquidity Aggregates" (18637); FSC "Plans to Accelerate Structural Reforms in Finance" (18636).*

**A · Themes in play**

| Rank | Theme | Assets | Banks talking | Why it matters to the PM |
|---|---|---|---|---|
| 1 | BoK decides today — +25bp to 2.75% the base case | Rates, KRW | Nomura, GS, JPM | The day's live Asian decision; the path is the debate |
| 2 | Market prices the most hikes in AEJ (≥100bp) vs houses' 75bp | Rates | Nomura | The terminal-rate/cut-path fight — Korea rates rich |
| 3 | Semiconductor-export cycle underwrites the tech strength | KRW, equities, rates | JPM, GS | Export prices +48.9% y/y; the growth engine |
| 4 | Oil relief in June trade prices; employment bottoming | Rates | JPM | Import prices −3.4% m/m (energy −13.4%); jobless 2.7% |

**B · The "why"** Korea's central event is today's Bank of Korea decision. **A +25bp hike to 2.75% is the base case** (`cb_events` 65683; survey/forecast 2.75%, prior 2.50%, actual null at compile — the announcement lands 10:00 KST / 01:00 UTC, still pre-decision). The fight is over the path, not the meeting: **Nomura (18627)** flags that the market is "clearly pricing Korea with the most hikes in AEJ — at least 100bp over the next 12 months — versus 75bp as the base case of our economics team" (a hike once per quarter), with 2yfwd3y Korea NDIRS already back at their 2022 highs (when CPI was near 6%); it therefore maintains a **receive Sep-5y Korea vs Taiwan NDIRS** RV position but **cuts conviction to 3/5 from 4/5 into the meeting**, noting the recent KOSPI and USD/KRW declines "should reduce the likelihood of a very hawkish BOK stance," against the headwind of the government revising 2026 growth up to 3% and a likely second supplementary budget. On the data, the June prints lean disinflationary and constructive: **import prices fell −3.4% m/m sa** (energy −13.4%, the oil relief) while **export prices ran +48.9% y/y** on semiconductor/tech strength (JPM 18665; BoK 18374), and **the jobless rate eased to 2.7%** (from 2.8%) on a 66k job gain led by a manufacturing rebound — JPM (18624) reads the labour trend as "gradually bottoming out." **KRW firmed +0.13% DoD** on the soft USD, and **KTB/CD swaps eased into the decision (2y −2.7bp / 10y −0.4bp)**; KOSPI 200 was carried +1.25% at the 07-14 close. FSC (18636) flagged accelerated financial-structural reforms.

**C · Consensus views**

| Theme | Banks | Shared claim | Evidence cited | What consensus is missing |
|---|---|---|---|---|
| A +25bp hike today is the base case | Nomura, GS, JPM | BoK hikes to 2.75%; no significant dovish surprise expected | Survey/forecast 2.75%; growth revised to 3% | The path after — market's ≥100bp vs houses' 75bp over 12 months |
| June data disinflationary; tech-export strength | JPM, BoK | Import prices −3.4% (oil relief); export prices +48.9% on semis | Energy import −13.4%; jobless 2.7% | How the semiconductor cycle + FX feed the BoK's terminal call |

**D · Differentiated / unique views**

| Bank | Asset | The view | Why it's different | Hidden assumption | Falsifier |
|---|---|---|---|---|---|
| Nomura | Rates | Receive Sep-5y Korea vs Taiwan NDIRS (conviction cut to 3/5) — Korea rates price too many hikes vs a 75bp base | Trades the market-vs-house hike-path gap on valuation, into the BoK event | The BoK delivers ~once-per-quarter (75bp/12m), not the market's ≥100bp | A hawkish BoK / a sustained tech-led growth upgrade validates the market path |

Trade rows: **#11** (Nomura receive Korea vs Taiwan + Dec-1s4s Korea steepener). **DEPTH:** KR `econ.fact_indicator` deep (loaded); trade prices, employment and money aggregates are FACT in `cb_events`. The verified anchor is the current 2.50% policy rate into today's decision (65683). **Flags:** BoK decision 07-16 forward (actual null at compile — releases 10:00 KST); KTB is CD/KOFR swap (`fact_bond_yield` EMPTY); the ≥100bp market path vs Nomura's 75bp base unreconciled (both shown); KOSPI is the 07-14 stale close.
...
- **South Korea** — Nomura "Korea rates: receive versus Taiwan" (18627), JPM "June employment" (18624) + "June trade prices: oil relief and tech strength" (18665), GS Korea Daily (18586), BoK Export/Import Prices (18374).
...
- **Bank of Korea** — the TE row (65683) carries the survey/forecast (2.75%) and the null actual at compile (releases 10:00 KST / 01:00 UTC — still pre-decision); the BQL row (41390) shows survey 2.75 with no actual. Used TE. Korea trade prices/unemployment taken from the TE lane (60920/60924) over the BQL duplicates.
...
- **Korea hike path** — the **market prices ≥100bp of hikes over 12 months** (the most in Asia-ex-Japan) vs the **houses' ~75bp** base (Nomura 18627, once-per-quarter); both shown ahead of today's BoK.
...
**Differentiated-view count (§9.D):** US 3 · Canada 2 · UK 1 · China 3 · Japan 2 · South Korea 1 · Hong Kong 0 · New Zealand 2 · Australia 1 · Singapore 2 · Indonesia 2 · Thailand 0 · Malaysia 0 · Philippines 0 · India 3 = **22 differentiated-view rows across 15 country/region blocks** (14-country universe + China; quiet-country floor met for HK/TH/MY/PH with a real A+B read grounded in the flagship/tape).
...
- **North Asia (c1):** **CN** 18719, 18717, 18625, 18647, 18763, 18723, 18628, 18632, 18731, 18626, 18722, 18605, 18707, 18614, 18678, 18644, 18671, 18729, 18768, 18608, 18598, 18635, 18359 · **JP** 18646, 18630, 18669, 18668, 18726, 18621, 18623, 18584, 18694, 18695, 18799, 18846 · **KR** 18627, 18624, 18665, 18586, 18589, 18774, 18374, 18637, 18636 · **HK** 18359, 18658, 18845.
